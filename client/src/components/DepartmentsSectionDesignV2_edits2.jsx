    ...
    <section className="relative overflow-hidden bg-[#f8fbfe] px-6 py-16 md:px-16 md:py-24 xl:px-24">
      ...
      <div className="relative space-y-10">
        <div className="grid items-start gap-10 lg:grid-cols-[0.85fr_1.15fr]">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-base leading-8 text-slate-600">
              ...
              teams, advanced facilities, and a patient-first healthcare
              approach.
            </p>
        ...
        <motion.div
          ...
          className="relative"
        >
          <button className="dept-swiper-prev absolute -left-5 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-md transition hover:border-[rgba(21,98,160,0.35)] hover:text-[rgb(21,98,160)]">
            <ChevronLeft className="h-5 w-5" />
          </button>

          <button className="dept-swiper-next absolute -right-5 top-1/2 z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-md transition hover:border-[rgba(21,98,160,0.35)] hover:text-[rgb(21,98,160)]">
          ...
          <div className="px-2 py-2">
            ...
            >
              {departments.map((item) => {
                ...
                return (
                  <SwiperSlide key={item.title} className="!h-auto box-border">
...
function DeptCard({ item, isActive, setActive }) {
  return (
    <motion.button
      ...
      className={[
        "group flex h-full w-full min-h-[120px] cursor-pointer rounded-[24px] border p-4 text-left transition-all duration-300",
        isActive
