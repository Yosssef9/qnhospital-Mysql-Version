...
import { useTranslation } from "react-i18next";
import SEO from "../components/SEO";
import { useQnhHistoryPage } from "../api/strapi";

export default function QnhHistory() {
  const { t, i18n } = useTranslation();
  const isRTL = i18n.dir() === "rtl";

  const { data } = useQnhHistoryPage();

  const fallbackSections = [
    {
      year: t("qnhHistoryPage.sections.year1993.date"),
      image: "/images/QnhHistory/Picture2.jpg",
      description: t("qnhHistoryPage.sections.year1993.paragraph"),
    },
    {
      year: t("qnhHistoryPage.sections.year1998.date"),
      image: "/images/QnhHistory/prince sultan.png",
      description: t("qnhHistoryPage.sections.year1998.paragraph"),
    },
    {
      year: t("qnhHistoryPage.sections.year1999_2008.date"),
      image: "/images/QnhHistory/Picture3.jpg",
      description: t("qnhHistoryPage.sections.year1999_2008.paragraph"),
    },
    {
      year: t("qnhHistoryPage.sections.year2009.date"),
      image: "/images/QnhHistory/SZN_9637.jpg",
      description: t("qnhHistoryPage.sections.year2009.paragraph"),
    },
    {
      year: t("qnhHistoryPage.sections.year2010Now.date"),
      image: "/images/QnhHistory/DSC_1078.jpg",
      description: t("qnhHistoryPage.sections.year2010Now.paragraphs", {
        returnObjects: true,
      }),
    },
  ];
  ...
  const sections =
    data?.historySections?.length > 0 ? data.historySections : fallbackSections;
  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"}>
      ...
      <BreadcrumbArea
        imgUrl={data?.breadcrumbImage || "/images/about-us-header.jpg"}
        items={[
          { label: t("navbar.home"), to: "/" },
          { label: t("qnhHistoryPage.breadcrumbTitle") },
        ]}
          ...
          return (
            ...
            >
              <img
                src={section.image}
                alt={section.year}
                className="h-[200px] w-full rounded-2xl object-cover shadow-lg md:h-[250px] md:w-[400px] lg:h-[300px]"
              />
